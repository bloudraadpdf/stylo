...
/// Specified value of `-bd-pdf-mark-crop-color`.
///
/// Symmetric to [`BdRegistrationColour`]: lets authors override the
/// crop-mark colour independently of the shared

...
impl AbsoluteColor {
    ...
    fn to_color_space_impl(&self, color_space: ColorSpace, keep_numeric_hue: bool) -> Self {
        ...
        // A hue generated by color-space conversion is missing when it cannot
        // affect the resulting color. An authored hue keeps its value because
        // same-space conversion returns above before reaching this branch.
        ...
        let source_hue_powerless = match self.color_space {
            ...
            Lch => self.c1().is_some_and(|chroma| chroma <= 0.0015),
